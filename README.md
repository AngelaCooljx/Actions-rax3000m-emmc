...
使用 GitHub Actions 在线编译定制 CMCC RAX3000M eMMC version (custom U-Boot layout) 的 ImmortalWrt-23.05.1 固件
...
## 固件特性
使用 [ImmortalWrt 官方仓库](https://github.com/immortalwrt/immortalwrt/tree/v23.05.1)，'v23.05.1' tag 源码编译，无线使用 mt76 开源驱动，主线已支持硬件加速，内核版本 5.15，软件包支持在线安装
...
**如需在线安装 kmod 内核模块类型软件包，你需要手动下载 https://mirrors.vsean.net/openwrt/releases/23.05.1/targets/mediatek/filogic/packages/kernel_5.15.137-1-904c4c7394bedf0cdae64cbc242922fd_aarch64_cortex-a53.ipk 该软件包并上传安装，之后即可正常在线安装其他 kmod 软件包**
